...
\StringTok{  }\KeywordTok{kable_styling}\NormalTok{(}
    ...
    \DataTypeTok{full_width =}\NormalTok{ F, }\DataTypeTok{position =} \StringTok{"center"}\NormalTok{, }\DataTypeTok{repeat_header_text =} \StringTok{"（续）"}
\NormalTok{  ) }\OperatorTok{%>%}
...
\StringTok{  }\KeywordTok{footnote}\NormalTok{(}
    ...
    \DataTypeTok{general =} \StringTok{"* 星号表示的内容很长很长很长很长很长长长长长长长长长长长长长长长长长长长长长长长长长长长长长长长长长长"}
\NormalTok{  )}
\end{Highlighting}
\end{Shaded}
